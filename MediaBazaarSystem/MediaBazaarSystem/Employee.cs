...
namespace MediaBazaarSystem
{
    public class Employee : Staff
    {
        ...
        public Employee(int ID, String firstName, String lastName, int age, DateTime birthDate, String address, String role, double salary, int hoursAvailable, String email, Contract contract) //Removed hoursworked
        {
            dbID = ID;
            FirstName = firstName;
            LastName = lastName;
        ...
        public void EditEmployee(String firstName, String lastName, DateTime birthDate, String address, String role, double salary, int hoursAvailable, String email, Contract contract)
        {
            FirstName = firstName;
            LastName = lastName;
            dateOfBirth = birthDate.Date;
